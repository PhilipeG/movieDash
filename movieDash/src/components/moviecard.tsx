...
export default function MovieCard({
  ...
  return (
    // O contêiner principal define a proporção do poster (2:3)
    <div
    ...
    >
      ...
      {/* Overlay com gradiente para o conteúdo, posicionado sobre a imagem */}
      ...
      {/* botões de rank e Remover no topo */}
      {onRemoveFromFavorites && (
        <button
        ...
        >
          <svg xmlns="http://www.w.3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
        </button>
      )}
